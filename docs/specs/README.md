...
| File | Responsibility |
|---|---|
| [communication.md](communication.md) (outline; details pending) | Communication scenarios for the Agent CLI and Telegram Users: subscriptions, sending, reading, ack, wait, Reply/@, leaving temporarily, and resuming. |
